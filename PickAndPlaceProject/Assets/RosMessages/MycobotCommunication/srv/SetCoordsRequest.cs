...
{
    [Serializable]
    public class SetCoordsRequest : Message
    {
        ...
        public SetCoordsRequest(float x, float y, float z, float rx, float ry, float rz, sbyte speed, sbyte model)
        {
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        public static SetCoordsRequest Deserialize(MessageDeserializer deserializer) => new SetCoordsRequest(deserializer);

        private SetCoordsRequest(MessageDeserializer deserializer)
        {
